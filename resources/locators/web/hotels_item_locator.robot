...
...            btn_book_now_by_roomtype_and_index=xpath=(//h3[contains(@id,'hotel-cart-room-') and contains(text(),'***room_type***')]/ancestor::div[contains(@class,'bg-card-room-detail')]//button[contains(text(),'Book now')])[***index***]
