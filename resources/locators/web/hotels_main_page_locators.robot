...
${hotels_main_page_locators.lbl_adults_amount}                           css=[role="menuitem"]:has(div:text-is("${guests_and_rooms.t_adults}"))
...
${hotels_main_page_locators.lbl_children_amount}                         css=[role="menuitem"]:has(div:text-is("${guests_and_rooms.t_children}"))
