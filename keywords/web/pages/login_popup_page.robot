...
Click login with email or mobile number
    ${email_or_mobile_locator}=    Replace String    ${login_popup_locators.btn_email_or_mobile_number}   {TEXT}    ${login_popup.t_email_or_mobile_login_or_signup}
...
Click login button on login or sign up with email or mobile number method   
