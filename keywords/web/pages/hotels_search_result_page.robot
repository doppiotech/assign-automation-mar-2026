...
Check if search result page display
    ...
    common_web.Wait until page display    ${hotels_search_list_section_locaator}[lbl_total_search_result_items]    ${retry_times}    ${interval_for_retry}

Select hotel by index from search result
    [Arguments]    ${hotel_index}
    ${hotel_locator}=        String.Replace string    ${hotels_search_list_section_locaator}[lbl_search_result_item_by_index]    ***hotel_index***    ${hotel_index}
