...
Open web browser by url
    ...
    [Arguments]        ${url}    ${supported_browser}=${default_browser}    ${headless_mode}=${False}    ${timeout}=${default_timeout}
    Browser.New browser     browser=${supported_browser}    headless=${headless_mode}    timeout=${timeout}
