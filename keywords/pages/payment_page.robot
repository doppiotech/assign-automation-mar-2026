...
Fill credit card name
    ...
    Log To Console    Filled Card Holder Name: ${card_holder_name}
...
Fill credit card expiry date
    ...
    Log To Console    Filled Expiry Date: ${expiry_date}
...
Fill credit card cvv
    ...
    Log To Console    Filled CVV Code
...
Tick save credit card information
    ...
    Log To Console    Ticked Save Card Information via Span
...
Click confirm booking button
    ...
    Log To Console    Successfully clicked Confirm Booking!
    BuiltIn.Sleep    20s
