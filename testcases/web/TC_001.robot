...
TC_001 Verify Hotel Booking with Credit Card Payment
    ...
    login_feature.Login
    ...     email=${TC_001.account.email}
    ...     password=${TC_001.account.password}
    common_web.Wait Page Load
    booking_hotels_feature.Booking hotels
    ...     destination=${TC_001.booking.destination}
    ...     destination_suggess=${TC_001.booking.suggess}
    ...
    ...     check_in_MonthYear=${TC_001.booking.check_in_month_year}
    ...     number_of_rooms=${TC_001.booking.rooms}
    ...     number_of_adults=${TC_001.booking.adults}
    ...     number_of_children=${TC_001.booking.children}
    ...     hotel_name=${TC_001.booking.hotel_name}
    ...     room_category=${TC_001.booking.room_category}
    ...     gender=${TC_001.account.gender}
    ...     first_name=${TC_001.account.first_name}
    ...     last_name=${TC_001.account.last_name}
    ...     email=${TC_001.account.email}
    ...     phone_number=${TC_001.account.phone_number}
    common_web.Wait Page Load
    payment_feature.Payment
    ...     card_number=${TC_001.credit_card.card_number}
    ...     card_name=${TC_001.credit_card.card_name}
    ...     expire_date=${TC_001.credit_card.expire_date}
    ...     cvv=${TC_001.credit_card.cvv}


    # #This Should be Group in one keywords name login
    # # nav_bar_page.Click login/signup button
    # # login_signup_page.Click email or mobile no. button
    # # login_signup_page.Fill email    ${TC_001.account.email}
    # # login_signup_page.Click login after fill email
    ...
    # #Select check-out date   check_in_date=${check_in_date}
